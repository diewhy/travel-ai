...
async function openReadyMoscowRoute() {
  // Готовый маршрут открывается без формы
  ...
  // Очищаем данные предыдущей AI-генерации
  routeTitle.value = ''
  routeAbout.value = ''
  pleinairs.value = []
  equipment.value = []
  ...
  history.value =
    'Готовый короткий военно-исторический маршрут по центру Москвы на 2–3 часа. Он посвящён ключевым местам памяти защитников Отечества и проходит по главным историческим локациям столицы.'
...
Короткий военно-исторический маршрут по центру Москвы продолжительностью 2–3 часа.

**1. Александровский сад**
Начало маршрута у стен Московского Кремля. Александровский сад — одно из наиболее значимых исторических пространств столицы, связанное с памятью о защитниках страны.

**2. Могила Неизвестного Солдата**
Главный мемориал воинской славы в центре Москвы. Он посвящён советским воинам, погибшим в годы Великой Отечественной войны.

**3. Вечный огонь**
Символ непрерывной памяти о погибших защитниках Отечества. Здесь проходит основная мемориальная часть маршрута.

**4. Пост №1**
Почётный караул у Вечного огня. Торжественная смена караула является одним из ключевых элементов маршрута.

**5. Манежная площадь**
Переходная точка между Александровским садом и Красной площадью, расположенная в самом центре исторической Москвы.

**6. Красная площадь**
Финальная точка маршрута. Главная площадь страны связана с военными парадами, государственными церемониями и важнейшими событиями российской истории.

**Формат маршрута**
Пеший маршрут для школьников, студентов, туристов, семей и участников патриотических мероприятий.

**Рекомендация**
Лучше начинать прогулку в первой половине дня. Для спокойного прохождения маршрута рекомендуется выделить не менее двух часов.`
