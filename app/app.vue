...
function openReadyMoscowRoute() {
  ...
  history.value = 'Готовый короткий военно-исторический маршрут по центру Москвы на 2-3 часа. Посвященный ключевым местам памяти защитников Отечества и проходит по самым узнаваемым историческим локациям столицы.'
...
**Формат**
Пеший маршрут. Подходит для школьников, студентов, туристов и участников патриотических мероприятий.
