...
Формат маршрута: ${body.routeDuration}
...
- В конце укажи примерный итоговый бюджет.
- Пиши красиво, но кратко.
Если routeDuration = "short" — составь маршрут на 2–3 часа, без деления на дни.
Если routeDuration = "day" — составь маршрут на один полный день.
Если routeDuration = "long" — составь маршрут на 2–3 дня.
Для короткого маршрута не пиши "День 1", "День 2", "День 3".
...
Верни ответ строго в JSON формате:
{
  ...
  "about": "Краткое описание маршрута на 2-3 предложения",
  "route": "Краткий общий маршрут одной строкой",
  "history": "Краткая информация о локации",
  "memoryPlaces": [
  ...
  "pleinairs": [
    {
      ...
      "skill": "Художественный навык",
      "history": "Кратко об истории места",
      "duration": "60 минут",
...
СТРОГО:
- Поле "pleinairs" обязательно должно быть заполнено.
- Количество объектов в "pleinairs" должно соответствовать количеству пленэров.
- Не оставляй title, about, pleinairs, equipment и summary пустыми.
- Никакого текста вне JSON не добавляй.
`
